...
{
    public class AtomFeedElement : AtomElement
    {
        internal AtomFeedElement(string prefix, string localname, string ns, AtomDocument doc)
        ...
        public XmlNodeList Entries
        {
            get
            {
                return CreateAtomElementList("entry");
            }
        }
    }
}
